...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registries.ITEM, new Identifier(AutomaticSorterMod.MOD_ID, name), item);
    }

    public static void registerItems() {
        AutomaticSorterMod.LOGGER.info("Registering Mod items for " + AutomaticSorterMod.MOD_ID);
